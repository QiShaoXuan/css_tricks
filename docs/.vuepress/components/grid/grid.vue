...
<template>
  <div class="grid-container">
    ...
    <section class="property-value" v-if="choosenGridItem">
      <pre class="language-css"><code ref="gridItemCss"></code></pre>
      <div class="value-set">
        <div class="key-value w-100">
          <span class="key need-min-width">grid-column-start:&nbsp;&nbsp;</span>
          <el-input-number :min="1" :max="this.gridTemplateColumns.length" size="mini" v-model="choosenGridItem.gridColumnStart"></el-input-number>
        </div>
        <div class="key-value w-100">
          <span class="key need-min-width">grid-column-end:&nbsp;&nbsp;</span>
          <el-input-number :min="1" :max="this.gridTemplateColumns.length+1" size="mini" v-model="choosenGridItem.gridColumnEnd"></el-input-number>
        </div>
        <div class="key-value w-100 ">
          <span class="key need-min-width">grid-row-start:&nbsp;&nbsp;</span>
          <el-input-number :min="1" :max="30" size="mini" v-model="choosenGridItem.gridRowStart"></el-input-number>
        </div>
        <div class="key-value w-100">
          <span class="key need-min-width">grid-row-end:&nbsp;&nbsp;</span>
          <el-input-number :min="1" :max="30" size="mini" v-model="choosenGridItem.gridRowEnd"></el-input-number>
        </div>
      </div>
    </section>
  </div>
